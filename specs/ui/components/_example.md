...
<!-- mentor:file
Replace [ComponentName] with the actual component name. This file documents a single UI component. Fill every section before implementation begins — incomplete component specs lead to inconsistent implementations across different screens.
priority: medium
-->
...
<!-- mentor
Any implementation notes, edge cases, or known limitations that don't fit in the other sections. Accessibility behavior, animation behavior, responsive behavior, and known browser quirks belong here.

quality signals:
- This section is only present if there is something worth noting
- Notes are specific enough to act on, not general reminders
- Known limitations are honest and don't pretend problems don't exist
-->
